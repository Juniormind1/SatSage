...
und gibt bis zu 10 erreichbare Onion-Server als nummerierte .env-Eintraege aus.
Die Serverliste selbst liegt in ``core.electrum_servers`` und wird hier
re-exportiert. main.py nutzt nur manuell gesetzte .env-Werte."""

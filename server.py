...
if __name__ == "__main__" and "--splash-only" in sys.argv:
    from httpserver.splash import lauf_splash_kind_einstieg

    raise SystemExit(lauf_splash_kind_einstieg(sys.argv))
...
# AppState + Managed-Konstanten/-Helfer → httpserver.app_state (Re-Export).
from httpserver.app_state import (  # noqa: E402
    AppState,
    _MANAGED_MODI,
    _MANAGED_PLATTFORM,
    _NODE_MANAGED,
    _managed_by_from_env,
    _managed_mode,
)
...
# Scramble/Unlock/Bootstrap-Passwort → httpserver.scramble (Re-Export darunter).
...
from httpserver.scramble import (  # noqa: E402
...
# Electrs-Verbindungsentsorgung + Wallet-Tip-Sync → httpserver.wallet_sync (Re-Export unten).
...
from httpserver.wallet_sync import (  # noqa: E402
    _tip_sync_abbrechen,
...
from httpserver.splash import (  # noqa: E402
    _splash_bei_browser,
    _splash_laden,
    _splash_schliessen,
    _splash_start,
    ...
    lauf_splash_kind_einstieg,
)
from httpserver.main_cli import (  # noqa: E402
    _http_debug_log,
    _http_loop_bis_strg_c,
    _httpd_binden,
    _konsole_auf_utf8,
    _oeffne_browser_sicher,
    _port_belegt_errno,
    build_argumente,
    main_cli,
)
